...
class DAQ_0DViewer_DAQmx_PLcounter(DAQ_Viewer_base):
    ...
    def update_tasks(self):
        ...
        # Stop the tasks before updating them
        ...
        clock_channel = self.controller["clock"].task.co_channels.add_co_pulse_chan_freq(
            self.settings.child("clock_channel").value(),
        ...
        channel.ci_semi_period_term = "/" + self.settings.child("clock_channel").value() + "InternalOutput"
